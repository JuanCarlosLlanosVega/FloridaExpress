...
const ListaFlotas = () => {
    ...
    // Función para eliminar una flota
    const handleDelete = async (id) => {
        await deleteDoc(doc(db, 'flotas', id));
        fetchFlotas();
    };

    // Función para editar (ejemplo básico)
    const handleEdit = async (id) => {
        const nuevoEstado = prompt("Ingrese el nuevo estado (Activo/Inactivo):");
        if (nuevoEstado) {
            await updateDoc(doc(db, 'flotas', id), { estado: nuevoEstado });
            fetchFlotas();
        }
    };
                ...
                <tbody>
                    {flotas.map((flota) => (
                        <tr key={flota.id}>
                            ...
                            <td>
                                <button onClick={() => handleEdit(flota.id)}>Editar</button>
                            </td>
                            <td>
                                <button onClick={() => handleDelete(flota.id)}>Eliminar</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
...
const ListaFlotas = () => {
    ...
    // Función para mostrar el modal con los datos del registro seleccionado
                ...
                <div className="modal">
                    <div className="modal-content">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="tipo_vehiculo" value={selectedFlota.tipoVehiculo} onChange={handleChange} />
                        </div>
                        <div className="form-group">
                            <label>Placa</label>
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" name="año_fabricacion" value={selectedFlota.añoFabricacion} onChange={handleChange} />
                        </div>
